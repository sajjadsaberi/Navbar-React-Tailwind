...
function Headers() {
    ...
    <nav className='bg-gray-900 flex items-center justify-between gap-96'>
        <span className='text-gray-950 pt-0 pb-6 pl-3.5 font-Iran text-sm'><input type='text' placeholder='جست و جو ...' className='absolute w-44 h-6 outline-none rtl pr-1' required /></span>
